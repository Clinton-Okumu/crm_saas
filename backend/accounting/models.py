...
class Transaction(models.Model):
    ...
    status = models.CharField(max_length=20, choices=TRANSACTION_STATUS, default='draft')
...
class TransactionLine(models.Model):
    ...
    def clean(self):
        ...
        if self.debit_amount == 0 and self.credit_amount == 0:
            raise ValidationError("Either debit or credit amount must be greater than zero")
